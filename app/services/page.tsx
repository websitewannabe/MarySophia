...
export default function ServicesPage() {
  const jsonLd = {
    ...
    areaServed: {
      "@type": "Place",
      name: ["Online", "Worldwide", "United States", "Buckingham PA region"],
    },
    hasOfferCatalog: {
      "@type": "OfferCatalog",
      ...
      itemListElement: [
        {
          ...
          itemOffered: {
            ...
            description: "Channeled soul wisdom from the Divine Mother to support your spiritual path.",
          },
        },
        {
          "@type": "Offer",
          itemOffered: {
            ...
            description: "Heart-centered support sessions for healing, transition, and divine alignment.",
          },
        },
        {
          "@type": "Offer",
          itemOffered: {
            ...
            description: "Courses and mentorship in Divine Feminine traditions and spiritual formation.",
          },
        },
        {
          "@type": "Offer",
          itemOffered: {
            ...
            description: "Sacred community and lineage devoted to living the Way of the Divine Mother.",
          },
        },
      ],
    },
          ...
          <section className="mb-20">
            <div className="max-w-4xl mx-auto">
              ...
              <div className="space-y-8">
                ...
                <div>
                  <h3 className="text-xl text-[#002147] mb-3 font-playfair">
                    What is spiritual counseling, and how does it differ from traditional therapy?
                  </h3>
                  <p className="text-gray-800 font-open-sans leading-relaxed">
